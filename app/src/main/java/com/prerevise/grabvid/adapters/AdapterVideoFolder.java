...
public class AdapterVideoFolder extends RecyclerView.Adapter<AdapterVideoFolder.ViewHolder> {
    ...
    private ArrayList<ModelVideo> al_video;
    ...
    public AdapterVideoFolder(Context context, ArrayList<ModelVideo> al_video, Activity activity) {
    ...
    @NotNull
    @Override
    public AdapterVideoFolder.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void update(final ModelVideo video, final int id) {
